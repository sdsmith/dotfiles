...
;;; Commentary:
;; source: https://github.com/DamienCassou/hierarchy/blob/master/examples/hierarchy-examples-major-modes.el
;; NOTE(sdsmith): Renamed file and functions.
;;
...
(defun hierarchy-major-modes--major-mode-p (f)
...
(defun hierarchy-major-modes--all-major-modes ()
  "Return a list of all major modes."
  (let ((major-modes (list)))
    (mapatoms
     (lambda (symbol)
       (when (hierarchy-major-modes--major-mode-p symbol)
         (setq major-modes (cons symbol major-modes)))))
    major-modes))

(defun hierarchy-major-modes--major-mode-parent (f)
...
(defun hierarchy-major-modes--major-mode-build-hierarchy ()
  "Return a hierarchy of all major modes."
  (let ((hierarchy (hierarchy-new)))
    (hierarchy-add-trees hierarchy (hierarchy-major-modes--all-major-modes) #'hierarchy-major-modes--major-mode-parent)
    (hierarchy-sort hierarchy)
    hierarchy))

(defun hierarchy-major-modes-display-major-modes ()
  "Display all major modes and their inheritance relationship."
  (interactive)
  (let* ((hierarchy (hierarchy-major-modes--major-mode-build-hierarchy))
...
;; (hierarchy-major-modes-display-major-modes)

(provide 'hierarchy-major-modes)
;;; hierarchy-major-modes.el ends here
